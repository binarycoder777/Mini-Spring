...
import com.cqut.atao.springframework.beans.factory.config.BeanFactoryPostProcessor;
...
import com.cqut.atao.springframework.context.ConfigurableApplicationContext;
import com.cqut.atao.springframework.context.event.ApplicationEventMulticaster;
import com.cqut.atao.springframework.context.event.ContextClosedEvent;
import com.cqut.atao.springframework.context.event.ContextRefreshedEvent;
import com.cqut.atao.springframework.context.event.SimpleApplicationEventMulticaster;
 ...
 * @Description 抽象应用上下文
 * @createTime 2023年08月02日 23:14:00
 */
